...
def recherche_dans_cleaned_request(cleaned_request, inversed_index, terms_dictionary):
    """
    ...
    and_dic = recherche(and_list, terms_dictionary, inversed_index)
    ...
    not_dic = recherche(not_list, terms_dictionary, inversed_index)
    ...
    or_dic = recherche(or_list, terms_dictionary, inversed_index)
...
def get_posting(term_id, inversed_index):
    """
    fonction qui prends en entrée un term_id et la localisation de inversed_index
...
def recherche(words_list, inversed_index, terms_dictionary):
    """
    ...
    for word in words_list:
        term_id = find_term_id(word, terms_dictionary)
        posting = get_posting(term_id, inversed_index)
        doc_ids = []
        try:
